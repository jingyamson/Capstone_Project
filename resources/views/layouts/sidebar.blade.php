...
<aside id="sidebar" class="sidebar bg-white p-3 border-end" style="border-color: #E3A833;">
    ...
    <div class="side-link mb-3">
        ...
        <div class="side-link mb-3">
            <a class="nav-link d-flex align-items-center text-dark p-2 rounded hover-bg">
                <i class="bi bi-people me-2 fs-5"></i><span>Attendance</span>
            </a>
        </div>
        <div class="side-link mb-3">
            <a class="nav-link d-flex align-items-center text-dark p-2 rounded hover-bg">
                <i class="bi bi-people me-2 fs-5"></i><span>Record Students</span>
            </a>
        </div>
        <div class="side-link mb-3">
            <a class="nav-link d-flex align-items-center text-dark p-2 rounded hover-bg">
                <i class="bi bi-people me-2 fs-5"></i><span>Recitation</span>
            </a>
        </div>
    ...
    <div class="side-link mb-3">
            <a class="nav-link d-flex align-items-center text-dark p-2 rounded hover-bg" href="{{ route('subjects.addsubject') }}">
